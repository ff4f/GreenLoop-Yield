...
export const mockCarbonLots = [
  ...
  {
    id: "5",
    lotId: "PBCL-SO-GHA-005",
    projectName: "Solar Water Pumps 200 units",
    ...
    status: "LISTED",
    tokenId: "0.0.600115",
    projectImage: "https://images.unsplash.com/photo-1466611653911-95081537e5b7?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
    proofHashes: {
      photo: "0xabc127",
      ndvi: "0xdef460",
      qc: "0xghi793"
  ...
  {
    id: "8",
    lotId: "PBCL-WD-ZAF-008",
    projectName: "Wind Energy 25 MW",
...
export const mockProofEntries = [
  ...
  },
  {
    id: "10",
    lotId: "PBCL-SO-GHA-005",
    proofType: "Solar panel verification",
    hash: "0xcdef00",
  ...
  },
  {
    id: "11",
    lotId: "PBCL-SO-GHA-005",
    proofType: "Energy output report",
    hash: "0xghij11",
  ...
  },
  {
    id: "17",
    lotId: "PBCL-WD-ZAF-008",
    proofType: "Power generation log",
    hash: "0xefgh77",
...
export const mockProjectSheets = [
  ...
  },
  {
    ...
    forwardPercent: 40,
    expectedTons: 31500,
    afterBufferTons: 28350,
    listedTons: 11340,
    estimatedValue: 113400,
    lotId: "PBCL-SO-GHA-011",
    tokenId: "0.0.600121",
    status: "DRAFT"
  }
];
